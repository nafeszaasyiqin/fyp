...
with open('scholarships.csv', mode='w', encoding='utf-8', newline='') as csv_file:
    fieldnames = ['Name', 'Link', 'Deadline', 'Study Level']
    ...
    for scholarship_div in scholarship_divs:
        ...
        if h_left_div:
            ...
            if a_tag:
                ...
                writer.writerow({'Name': name, 'Link': link, 'Deadline': deadline, 'Study Level': study_level})
